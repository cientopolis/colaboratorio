				...
				<g:if test="${recommendation}">
					<div class="show-component">
						<div id="instructions">
							...
							<g:if test="${recommendation.imagePath != null}">
						...
						<g:form controller="colaborator" action="project"
							...
							<div class="span5">
								<ul id="feedbackOptions">
									<input type="${recommendation.checkboxMode }"
										name="state" value="Done" /> <g:message
											code="bfcrowd.label.collab.project.feedback.done" />
											<br>
									<input type="${recommendation.checkboxMode }"
										name="state" value="Moderated Page" /> <g:message
											code="bfcrowd.label.collab.project.feedback.moderated" />
											<br>
									<input type="${recommendation.checkboxMode }"
										name="state" value="Already Done" /> <g:message
											code="bfcrowd.label.collab.project.feedback.already" />
								</ul>
							</div>
							<div class="span6">
